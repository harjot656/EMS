    ...
    public function make_dynamic_div($data){
       ...
       foreach($data['date'] as $key=>$value){
        ...
        foreach($data['date'] as $key=>$value){
            if(array_key_exists($value['date'], $dynamic_atten)){
                $result = $dynamic_atten[$value['date']];
                $html .="<td><div class='form-focus select-focus'><label class='control-label'></label><input class='time_select in_time' id=in_time#".$value['date']."  name=in_time#".$value['date']." value='".$result['in_time']."'  type=text placeholder=''></div></td>";
            }else{
        ...
        foreach($data['date'] as $key=>$value){
            if(array_key_exists($value['date'], $dynamic_atten)){
                $result = $dynamic_atten[$value['date']];
                $html .="<td><div class='form-focus select-focus'><label class='control-label'></label><input class='time_select out_time' id=out_time#".$value['date']." name=out_time#".$value['date']." value='".$result['out_time']."'  type=text placeholder=''></div></td>";
            }else
            {
        ...
        foreach($data['date'] as $key=>$value){
            if(array_key_exists($value['date'], $dynamic_atten)){
                $result = $dynamic_atten[$value['date']];
                $html .="<td><div class='form-focus select-focus'><label class='control-label'></label><input class='time_select' id=total_time#".$value['date']." name=total_time#".$value['date']." value='".$result['shift_hours']."' readonly  type=text placeholder=''></div></td>";
            }else{
