<script type="text/javascript" src="{{secure_asset('js/jquery-3.2.1.min.js')}}"></script>
		...
		<script type="text/javascript" src="{{secure_asset('js/jquery.slimscroll.js')}}"></script>
		<script type="text/javascript" src="{{secure_asset('js/select2.min.js')}}"></script>
		...
		<script type="text/javascript" src="{{secure_asset('js/additional-methods.js')}}"></script>
		<script type="text/javascript" src="{{secure_asset('js/add_employee.js')}}"></script>
