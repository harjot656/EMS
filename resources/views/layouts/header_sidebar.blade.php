<head>
		...
		<!--[if lt IE 9]>
			<script src="secure_assets/js/php5shiv.min.js"></script>
			<script src="secure_assets/js/respond.min.js"></script>
		<![endif]-->
    </head>
    <body>
            ...
            <div class="header">
                <div class="header-left">
                    <a href="index.php" class="logo">
						<img src="{{secure_asset('img/logo.png')}}" width="40" height="40" alt="">
					</a>
                </div>
				...
				<ul class="nav navbar-nav navbar-right user-menu pull-right">
					...
					<li class="dropdown">
						<a href="{{route('profile')}}" class="dropdown-toggle user-link" data-toggle="dropdown" title="Admin">
							<span class="user-img"><img class="img-circle" src="{{secure_asset('img/user.jpg')}}" width="40" alt="Admin">
